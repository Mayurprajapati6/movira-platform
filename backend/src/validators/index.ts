...
import { AnyZodObject, ZodEffects } from "zod"; // Add ZodEffects
 ...
 */
export const validateRequestBody = (schema: AnyZodObject | ZodEffects<any>) => { 
 ...
 */
export const validateQueryParams = (schema: AnyZodObject | ZodEffects<any>) => { 
    return async (req: Request, res: Response, next: NextFunction) => {
        try {
